...
You want to save the model into the server function. 
...
Probably, tidyverse, tidymodels, stacks, and patchwork. 
...
For categorical you could do choices in your inputID and for quantitative data you could chose to do a slider in the inputID. 
...
I'm was really interested in the UK surveillance systems and the fact that AI and facial recognition is essentially unregulated and the difference that people feel about surveilance systems. I think that depending on where data is collected and by whom, the data collected could be really biased. Also, the initial  

recitivism algorithms use for sentencing based on gender, race, class, offence, age, etc to determine risk and risk of repeat offending. and looking at probation times and hich risk probation and increased surveillance.  
